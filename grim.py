...
class Grim:
    ...
    def groyne_cells_from_lines(self):
        ...
        crs = self.input_groyne_line[0].crs().authid().lower()
        generated_groyne_cells = QgsVectorLayer("Polygon?crs={}".format(crs), "Groyne Cells", "memory")
        groynes = []
        ...
        while count < len(groynes) - 1:
            ...
            for point_combination in possible_point_combinations:
                line = QgsVectorLayer("LineString?crs={}".format(crs), "Line", "memory")
            ...
            groyne_outline = QgsVectorLayer("LineString?crs={}".format(crs), "Groyne Lines", "memory")
